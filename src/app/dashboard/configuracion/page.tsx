...
import { Settings, Globe, Layout, Bell, Calendar, ChevronDown, Plus, Minus } from 'lucide-react';
    ...
    <div className="max-w-4xl space-y-8 pb-16">
      ...
      <div className="bg-neutral-900 border border-neutral-800/50 rounded-2xl shadow-sm overflow-hidden flex flex-col md:flex-row min-h-[600px]">
        ...
        <div className="w-full md:w-64 border-b md:border-b-0 md:border-r border-neutral-800/50 p-4 space-y-1">
          <button className="w-full flex items-center gap-3 px-3 py-2.5 bg-indigo-500/10 text-indigo-400 rounded-lg font-medium transition-colors text-sm text-left">
            <Layout className="w-4 h-4" />
            Estilo de la aplicación
          </button>
          <button className="w-full flex items-center gap-3 px-3 py-2.5 text-neutral-400 hover:text-neutral-200 hover:bg-neutral-800/50 rounded-lg font-medium transition-colors text-sm text-left">
