...
// Replace ONLY the specific select for metodoPago. We'll use split/join.
const targetSelectBlock = `<select 
                  value={metodoPago} 
...
// There are TWO instances of this block! One for individual payment, one for global payment!
code = code.split(targetSelectBlock).join(replacement);
