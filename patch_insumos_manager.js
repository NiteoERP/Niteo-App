...
export default function InsumosManager({ initialInsumos, empresaId }: { initialInsumos: any[], empresaId: string }) {
  ...
  const handlePrint = () => {
    // Para simplificar la impresión y que sea compatible con todos los navegadores, abrimos una nueva ventana y escribimos HTML con estilos básicos para imprimir.
